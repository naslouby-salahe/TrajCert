...
_REGISTRY = (
    ...
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.VALIDATION,
        expansion=ExpansionDescription("3 Gamma x 2 q"),
        declared_cells=6,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.VALIDATION,
        expansion=ExpansionDescription("12 laws x 4 partitions"),
        declared_cells=48,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
    ...
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.VALIDATION,
        expansion=ExpansionDescription("12 laws x 4 partitions x 4 rho offsets"),
        declared_cells=192,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.VALIDATION,
        expansion=ExpansionDescription("12 laws x 3 adjacent pairs"),
        declared_cells=36,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.VALIDATION,
        expansion=ExpansionDescription("6 cases x 3 offsets"),
        declared_cells=18,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.VALIDATION,
        expansion=ExpansionDescription("12 laws x 5 safety-budget cases"),
        declared_cells=60,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
    ...
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.VALIDATION,
        expansion=ExpansionDescription("12 laws x 4 partitions x 5 offsets"),
        declared_cells=240,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
    ...
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.CONFIRMATORY,
        expansion=ExpansionDescription("6 laws x 3 pairs x 3 offsets"),
        declared_cells=54,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
        ...
        expansion=ExpansionDescription("4 partitions x 5 rho paired-law cells"),
        declared_cells=20,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
    ...
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.CONFIRMATORY,
        expansion=ExpansionDescription("12 laws x 2 partitions"),
        declared_cells=24,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.CONFIRMATORY,
        expansion=ExpansionDescription("10 laws x 4 partitions"),
        declared_cells=40,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.CONFIRMATORY,
        expansion=ExpansionDescription("8 laws x 5 safety-budget cases"),
        declared_cells=40,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.VALIDATION,
        expansion=ExpansionDescription("10 hand cases x 3 partitions"),
        declared_cells=30,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
    ...
    ExperimentDefinition(
        ...
        expansion=ExpansionDescription("6 laws x 4 partitions x 15 rho"),
        declared_cells=360,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
        ...
        evidence_class=EvidenceClass.ROBUSTNESS,
        expansion=ExpansionDescription("6 laws x 3 rho"),
        declared_cells=18,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
        ...
        expansion=ExpansionDescription("9 axes x 7 levels"),
        declared_cells=63,
        configuration_gap_cells=0,
    ),
    ExperimentDefinition(
