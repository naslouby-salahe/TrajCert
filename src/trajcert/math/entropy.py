...
def binary_entropy_from_masses(harmful: Mass | Vector, correct: Mass | Vector) -> EntropyValue | Vector:
...
def weighted_binary_entropy(total_mass: Mass | Vector, harmful_rate: Probability | Vector | None) -> EntropyValue | Vector:
