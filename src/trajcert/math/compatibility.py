...
class CompatibilityAssessment:
    ...
    def is_compatible(self) -> bool:
        return (
            self.regime
            is not CompatibilityRegime.MODEL_INCOMPATIBLE
        )
...
def assess_compatibility(
    ...
    if minimum is None:
        return CompatibilityAssessment(
            regime=(
                CompatibilityRegime.NO_RESOLVED_MASS
            ),
            sensitivity_budget=SensitivityBudget(
                rho
            ),
    ...
    tau = observed_timing_information(
        summary
    )
    ...
    if rho < tau_value:
        ...
        regime = (
            CompatibilityRegime.COMPATIBLE_INTERVAL
        )

    return CompatibilityAssessment(
        regime=regime,
        sensitivity_budget=SensitivityBudget(rho),
