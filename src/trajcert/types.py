...
class NDArrayFloat64Annotation:
    ...
    def __get_pydantic_core_schema__(cls, source_type: Any, handler: GetCoreSchemaHandler) -> core_schema.CoreSchema:
        return core_schema.no_info_after_validator_function(cls.validate, core_schema.any_schema(), serialization=core_schema.plain_serializer_function_ser_schema(lambda x: x.tolist(), info_arg=False, return_schema=core_schema.list_schema(core_schema.float_schema())))
