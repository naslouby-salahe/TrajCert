...
def test_result_failure_claim_and_completion_models_cover_the_complete_roadmap_contract() -> None:
    assert set(PopulationMetricsRecord.model_fields) == {
        "law_name",
        "A",
        "G",
        "c",
    ...
    assert set(SequentialUpdateRecord.model_fields) == {
        "law_name",
        "stream_seed_index",
        "n_matured",
        "n_resolved",
    ...
    assert set(StreamMetricsRecord.model_fields) == {
        "law_name",
        "stream_seed_index",
        "ever_violation",
        "first_certified_n",
    ...
    assert set(PairedComparisonRecord.model_fields) == {
        "claim_family",
    ...
    assert set(StatisticalTestRecord.model_fields) == {
        "claim_name",
        "claim_family",
        "comparison_name",
        "metric_name",
    ...
    assert set(EffectSizeRecord.model_fields) == {
        "claim_name",
        "comparison_name",
        "metric_name",
        "n_pairs",
    ...
    assert set(ConfidenceIntervalRecord.model_fields) == {
        "claim_name",
        "comparison_name",
        "metric_name",
        "estimand",
    ...
    assert set(TheoremValidationRecord.model_fields) == {
        "theorem_name",
        "case_name",
        "law_name",
        "partition_name",
    ...
    assert set(FailureRecord.model_fields) == {
        "failure_record_key",
        "semantic_cell_key",
        "dependency_fingerprint",
    ...
    assert set(CompletionMarker.model_fields) == {
        "semantic_cell_key",
        "cell_plan_digest",
        "scientific_specification_digest",
        "scientific_dependency_digest",
    ...
    assert set(ClaimRegistryRecord.model_fields) == {
        "claim_name",
        "exact_claim",
        "research_question",
